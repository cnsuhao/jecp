...
CREATE TABLE `oa_filebox` (
  ...
  PRIMARY KEY  (`ID`)
) ENGINE=MyISAM AUTO_INCREMENT=126 DEFAULT CHARSET=utf8 COMMENT='文件站';
...
CREATE TABLE `oa_kaoqing` (
  ...
  PRIMARY KEY  (`ID`)
) ENGINE=MyISAM AUTO_INCREMENT=10 DEFAULT CHARSET=utf8 COMMENT='考勤';
...
CREATE TABLE `sale_baobeimoban` (
  `ID` bigint(20) NOT NULL auto_increment COMMENT 'id',
  `TITLE` varchar(20) NOT NULL COMMENT '模版标题',
  `CONTENT` longtext COMMENT '模版内容',
  PRIMARY KEY  (`ID`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='报备模版';
...
INSERT INTO `oa_filebox` VALUES ('125', '钓鱼岛.png.jpg', 'U1NAN28.jpg', '100000', null, '2013-08-23 09:35:42', 'img', '0.0145969');
INSERT INTO `oa_filebox` VALUES ('124', '钓鱼岛.png.jpg', 'U1NzoVd.jpg', '100000', null, '2013-08-23 09:34:48', 'img', '0.0145969');
...
INSERT INTO `oa_kaoqing` VALUES ('6', '100000', '17:50:20', '17:50:24', '2013-08-18', '8', '18', '2013', '127.0.0.1', '127.0.0.1', null, null, null, null, null, '', '1');
INSERT INTO `oa_kaoqing` VALUES ('7', '100000', '10:37:11', '17:00:46', '2013-08-19', '8', '19', '2013', '127.0.0.1', '127.0.0.1', null, null, null, null, null, 'fdsafsd', '1');
INSERT INTO `oa_kaoqing` VALUES ('8', '100000', '22:46:15', '22:46:18', '2013-08-21', '8', '21', '2013', '127.0.0.1', '127.0.0.1', null, null, null, null, null, '', '1');
INSERT INTO `oa_kaoqing` VALUES ('9', '100000', '00:31:01', null, '2013-08-22', '8', '22', '2013', '127.0.0.1', null, null, null, null, null, null, '', '1');
...
INSERT INTO `sys_menu` VALUES ('103', '跟进列表', 'sale/genjin', '1', null, '103', null, '64', '1', null);
INSERT INTO `sys_menu` VALUES ('104', '报备列表', 'sale/baobei', '1', null, '104', null, '64', '1', null);
