...
import net.loyin.model.crm.Custtype;
...
*Custtype
*/
@RouteBind(path = "custtype")
public class CusttypeCtrl extends AdminBaseController<Custtype> {
	public CusttypeCtrl() {
		this.tableName = Custtype.tableName;
		modelClass = Custtype.class;
	}
	public void dataGrid() {
		...
		Page<Record> p = Db.paginate(this.getParaToInt("page", 1), this.getParaToInt("rows", 20), "select t.ID,t.DESCRIP,t.CNAME,t.GJPL,t.JGQX,t.ZDSL,t.SORTNUM, 1 ", "from " + this.tableName+ " t where 1=1 " + where.toString(), param.toArray());
