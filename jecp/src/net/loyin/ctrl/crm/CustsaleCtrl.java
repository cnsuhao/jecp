...
import net.loyin.model.crm.Custsale;
...
*
*/
@RouteBind(path = "custsale")
public class CustsaleCtrl extends AdminBaseController<Custsale> {
	public CustsaleCtrl() {
		this.tableName = Custsale.tableName;
		modelClass = Custsale.class;
	}
	public void dataGrid() {
		...
		Page<Record> p = Db.paginate(this.getParaToInt("page", 1), this.getParaToInt("rows", 20), "select t.UID,t.CTIME,t.CUSTID, 1 ", "from " + this.tableName+ " t where 1=1 " + where.toString(), param.toArray());
